    ...
    <div className="home-page">
      ...
      <div className="learn-scroll">
        <div className="learn-card">
          <img src="/learn-identity.svg" alt="" className="learn-card-img" />
          <div className="learn-card-text">How to complete account identity authentication</div>
        </div>
        <div className="learn-card">
          <img src="/learn-payout.svg" alt="" className="learn-card-img" />
      ...
      <div className="explore-scroll">
        <div className="explore-card">
          <img src="/explore-solana.svg" alt="" className="explore-card-img" />
        ...
        <div className="explore-card">
          <img src="/explore-invite.svg" alt="" className="explore-card-img" />
          <div className="explore-card-body">
        ...
        <div className="explore-card">
          <img src="/explore-defi.svg" alt="" className="explore-card-img" />
          <div className="explore-card-body">
        ...
        <div className="explore-card">
          <img src="/explore-swap.svg" alt="" className="explore-card-img" />
          <div className="explore-card-body">
